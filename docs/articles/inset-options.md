...
Use `xlim` and `ylim` to set longitude/latitude limits. You can also set
axis breaks and labels. This example keeps the main islands and Okinawa
while dropping the Ogasawara inset.
...
![](inset-options_files/figure-html/axis-controls-1.png)
