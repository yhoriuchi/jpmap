...
description: "Use bundled Okinawa municipal boundaries and map municipality population."
...
Prefecture as of January 1, 2024. This example maps one simple fill variable:
2020 census population by municipality. The figure focuses on Okinawa Island so
the municipal boundaries are legible; the bundled boundary file still contains
the rest of Okinawa Prefecture.
