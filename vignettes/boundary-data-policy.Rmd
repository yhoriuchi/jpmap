...
- official MLIT N03 municipal boundaries for Okinawa Prefecture as of
  January 1, 2024;
- disputed-territory shapes that are included by default and can be excluded
  with `territorial_disputes = FALSE`.
...
Disputed-territory shapes are included by default and drawn quietly with the
rest of the map:
