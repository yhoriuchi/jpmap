...
- official MLIT N03 municipal boundaries for Okinawa Prefecture as of
  January 1, 2024;
- opt-in disputed-territory shapes used only when `territorial_disputes` is
  requested.
...
statement about sovereignty. The layer exists so users can make an explicit
and documented display choice rather than relying on silently included or
silently omitted small islands and reefs.
