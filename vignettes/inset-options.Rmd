...
and drawn quietly with the rest of the map. Set `territorial_disputes = FALSE`
to exclude them. You can also pass a character vector to include only selected
regions, such as `territorial_disputes = "senkaku"` or
...
```{r disputed-territories-highlight}
plot_jpmap(
  "prefecture",
